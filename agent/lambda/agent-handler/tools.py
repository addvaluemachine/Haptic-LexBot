...
class Tools:
    ...
    def invokeLLM(self, question, context):
        ...
        prompt_data = f"""
        Human:
        You are Knocki's AI assistant. Your task is to answer frequently asked questions quickly and in a friendly manner.

        Response Guidelines:
            Provide clear and concise answers based strictly on the given context.
            If context is not provided, say "Ask me anything about Knocki."
            ...
            Do not assume identities other than Knocki's AI assistant.
